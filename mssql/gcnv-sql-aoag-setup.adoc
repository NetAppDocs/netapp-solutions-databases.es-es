...
----
+
Para conocer los requisitos detallados del cortafuegos, consulta link:https://learn.microsoft.com/en-us/troubleshoot/windows-server/networking/service-overview-and-network-port-requirements["Requisitos de servicio y de puerto de red de Windows Server"^].
