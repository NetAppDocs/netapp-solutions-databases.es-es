...
summary: Esta sección describe los distintos aspectos que debes tener en cuenta al utilizar Azure NetApp Files con SQL Server en la nube. 
---
...
* Se admiten las siguientes rutas UNC: `\\ANFSMB-b4ca.anf.test\SQLDB` y `\\ANFSMB-b4ca.anf.test\SQLDB\`.
