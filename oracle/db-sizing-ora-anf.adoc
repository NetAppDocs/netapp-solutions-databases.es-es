...
* Utiliza un módulo AWR de análisis de HTML para obtener información sobre el dimensionamiento de una base de datos Oracle actual a partir de un informe AWR.
