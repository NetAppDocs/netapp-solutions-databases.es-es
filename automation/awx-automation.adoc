...
.. ingresar `\https://github.com/NetApp-Automation/na_oracle19c_deploy.git` como la URL de control de origen.
...
NOTE: requirements_config garantiza que tenga las bibliotecas correctas para ejecutar los otros roles.
